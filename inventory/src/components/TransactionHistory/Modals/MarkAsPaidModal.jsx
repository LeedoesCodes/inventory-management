        ...
        <div className="modal-body">
          ...
          <div className="success-message">
            ...
            <div className="success-content">
              ...
              <p>
                Mark this credit order as fully paid. This will close the order
          ...
          <div className="consequences-info">
            ...
            <div className="consequences-list">
              <div className="consequence-item positive">
                <FontAwesomeIcon icon={faCheckCircle} />
                <div>
                  <strong>Payment Status Updated:</strong> Order will be marked
                  as "Paid"
                </div>
              </div>
              <div className="consequence-item positive">
              ...
              <div className="consequence-item positive">
                <FontAwesomeIcon icon={faCreditCard} />
                <div>
                  <strong>Order Closed:</strong> Credit order will be completed
                </div>
              </div>
            </div>
          </div>
